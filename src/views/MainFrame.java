...
public class MainFrame extends JFrame {
    ...
    private JPanel createSidebar() {
        ...
        addSidebarButton(menuPanel, "Quản lý Hóa đơn", new views.HoaDonPanel(), gbc);
        addSidebarButton(menuPanel, "Quản lý Khách hàng", new views.KhachPanel(), gbc);
        addSidebarButton(menuPanel, "Quản lý Phòng", new views.PhongPanel(), gbc);
