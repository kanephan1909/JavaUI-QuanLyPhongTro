...
public class PhongPanel extends JPanel {
    ...
    public PhongPanel() {
        ...
        danhSachPhong = phongController.getAllPhong();
    ...
    private void searchRoom() {
        ...
        if(keyword.isEmpty()){
            loadData(phongController.getAllPhong());
            return;
        }
        ArrayList<Phong> filtered = new ArrayList<>();
        for (Phong p : phongController.getAllPhong()) {
    ...
    private void addRoom() {
        ...
        if(result == JOptionPane.OK_OPTION) {
            ...
            try {
                ...
                if(phongController.themPhong(newPhong)){
    ...
    private void editRoom() {
        ...
        if(result == JOptionPane.OK_OPTION) {
            ...
            try {
                ...
                if(phongController.suaPhong(editedPhong)) {
    ...
    private void deleteRoom() {
        ...
        if(confirm == JOptionPane.YES_OPTION) {
            if(phongController.xoaPhong(id)) {
