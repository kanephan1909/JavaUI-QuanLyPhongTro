...
public class HoaDonPanel extends JPanel {
    ...
    private ArrayList<HoaDonBUS> danhSachHoaDon;
    private HoaDonBUS hoaDonBUS;
    private KhachThueBUS khachThueBUS;
    private JComboBox<String> cboTrangThai;
    private JTextField txtMaPhong, txtTienDien, txtTienNuoc, txtTienPhong, txtThang;

    public HoaDonPanel() {
        hoaDonBUS = new HoaDonBUS();
        khachThueBUS = new KhachThueBUS();
        initComponents();
        loadData();
    }
    ...
    private void themHoaDon() {
        try {
            ...
            KhachThue khachThue = khachThueBUS.getKhachThueByPhong(maPhong);
            if (khachThue == null) {
    ...
    private void xoaHoaDon() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            HoaDon hd = danhSachHoaDon.get(selectedRow);
            hoaDonBUS.xoaHoaDon(hd.getMaHoaDon()); // Xóa trong DB
